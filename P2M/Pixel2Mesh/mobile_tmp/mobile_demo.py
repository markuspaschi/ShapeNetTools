...
import argparse
from  object_manipulation import Object3D

TMP_PNG = 'mobile_tmp/tmp.png'
TMP_OBJ = 'mobile_tmp/tmp.obj'

parser = argparse.ArgumentParser(description='Enter additional args, --training_date is mandatory')
parser.add_argument('--model', type=str, required=True, help='Model list (in data/checkpoint)')
...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('image', TMP_PNG, 'Testing image.')
...
object_manipulation = Object3D()
object_manipulation.setObj(TMP_OBJ)
object_manipulation.addNormals()
