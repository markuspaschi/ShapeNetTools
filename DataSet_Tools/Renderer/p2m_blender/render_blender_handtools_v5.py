...
class ShapeNetRenderer(BaseRenderer):
	...
	def _set_lighting(self):
		...
		light_data = bpy.data.lamps.new(name="New Lamp", type='SUN')
		...
		# light_2.rotation_euler = (0, radians(120), radians(90))
		light_2.data.energy = 0.3
		light_2.data.shadow_method = 'RAY_SHADOW'
		light_2.data.shadow_ray_sample_method = 'CONSTANT_QMC'
	...
	def set_lighting_viewport(self, azimuth, altitude, yaw):
        #altitude little above object -> shadow on bottom
		self.light_2.rotation_euler = (radians(-yaw),radians(altitude + 310),radians(azimuth + 270))
...
def main():
	...
	for i in range(0, args.views):
		...
		renderer.set_lighting_viewport(az,el,0)
