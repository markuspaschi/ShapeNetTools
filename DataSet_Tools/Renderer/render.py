...
DATASET_FILE_PATH = "/datasets_nas/mapa3789/ShapeNetHandTools"
OUTPUT_PATH = "/datasets_nas/mapa3789/Pixel2Mesh/HandToolsRendered/ShapeNetHandTools_V1"
...
RENDER_SCRIPT = "p2m_blender/render_blender_handtools.py"
N_JOBS_PARALLEL = 10
...
#LINUX
        os.system(current_dir + '/p2m_blender/blender_linux/blender --background --python %s -- --output_folder %s %s' % (RENDER_SCRIPT, OUTPUT_PATH, obj_path))
